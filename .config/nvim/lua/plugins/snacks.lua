            ...
            dashboard = {
                ...
                preset = {
                    keys = {
                        ...
                        { icon = "󰒲 ", key = "z", desc = "Lazy Update", action = ":Lazy update" },
                        { icon = "󰐅 ", key = "x", desc = "Treesitter Update Parsers", action = ":TSUpdate" },
                        { icon = "󱁤 ", key = "c", desc = "Mason Update Registries", action = ":MasonUpdate" },
                        { icon = "󱁤 ", key = "v", desc = "Mason Open", action = ":Mason" },
