...
alias ct='clear; tree -avAC --dirsfirst -I ".git|node_modules|venv|env"'
...
alias t='tree -avAC --dirsfirst -I ".git|node_modules|venv|env"'
alias tree1='tree -avAC --dirsfirst -I ".git|node_modules|venv|env" -L 1'
alias tree2='tree -avAC --dirsfirst -I ".git|node_modules|venv|env" -L 2'
alias tree3='tree -avAC --dirsfirst -I ".git|node_modules|venv|env" -L 3'
alias tree4='tree -avAC --dirsfirst -I ".git|node_modules|venv|env" -L 4'
alias tree5='tree -avAC --dirsfirst -I ".git|node_modules|venv|env" -L 5'
alias tree='tree -avAC --dirsfirst -I ".git|node_modules|venv|env"'
