...
-- updating
vim.keymap.set("n", "<leader>u1", function() require("lazy").update({ wait = true }) end)
vim.keymap.set("n", "<leader>u2", function() vim.cmd("MasonUpdate") end)
vim.keymap.set("n", "<leader>u3", function() vim.cmd("TSUpdate") end)
