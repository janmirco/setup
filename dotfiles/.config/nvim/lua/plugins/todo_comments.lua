return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "[t", function() todo_comments.jump_prev() end, { desc = "[Todo] Previous comment", silent = true })
        vim.keymap.set("n", "]t", function() todo_comments.jump_next() end, { desc = "[Todo] Next comment", silent = true })
